...
import torch.optim
from optimiser.base_manifold import ManifoldParameter
from optimiser.euclidean_manifold import Euclidean
        ...
        with torch.no_grad():
            for group in self.param_groups:
                ...
                for point in group["params"]:
                    ...
                    exp_avg.mul_(betas[0]).add_(1 - betas[0], grad) # momentum
                    exp_avg_sq.mul_(betas[1]).add_(                 # variance
                    ...
                    group["step"] += 1 # commenting out, error from original code MYSZ
